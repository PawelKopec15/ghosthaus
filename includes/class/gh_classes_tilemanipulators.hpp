...
public:
	...
	virtual ~TileManipulator();

	// To be called when targeted by player
	virtual message targethandler(Tile **board, const int board_h, const int board_w);
...
public:
	...
	message targethandler(Tile **board, const int board_h, const int board_w);
