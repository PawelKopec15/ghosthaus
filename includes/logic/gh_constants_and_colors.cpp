...
void init_game_pairs(const int _COLOR_GRAY, const int _COLOR_FLOOR)
{
	...
	init_pair(103, COLOR_RED,
			  _COLOR_FLOOR);  // red key / enemies / super flashlight / red gemstone / blood
...
const Item _green_key(0, 0, entity_graphics[1], 101, _green_key_name,
					  "You found a green key! You can use it to unlock a green door.", 0);

const string _red_key_name = "red key";
const Item _red_key(0, 0, entity_graphics[1], 103, _red_key_name,
					"You found a red key! You can use it to unlock a red door.", 0);

const string _skeleton_key_name = "skeleton key";
const Item _skeleton_key(0, 0, entity_graphics[8], 100, _skeleton_key_name,
						 "You found a skeleton key! It can open any door and is indestructible!",
						 0);

const string _flashlight_name = "flashlight";
const Item _flashlight(0, 0, entity_graphics[2], 102, _flashlight_name,
					   "You found a flashlight! Your field of view increases.", 0);

const string _super_flashlight_name = "super light";
const Item _super_flashlight(0, 0, entity_graphics[2], 103, _super_flashlight_name,
							 "You found a super flashlight! How did you do that?", 0);

const string _camera_name = "camera";
const Item _camera(0, 0, entity_graphics[3], 102, _camera_name,
				   "You found a camera! Press C to use it's flash.", 15, 0);

const string _stopwatch_name = "stopwatch";
const Item _stopwatch(0, 0, entity_graphics[10], 102, _stopwatch_name,
					  "You found a stopwatch! Press S to freeze time temporarily.", 25, 0);

const string _blue_gem_name = "blue gem";
const Item _blue_gem(0, 0, entity_graphics[9], 104, _blue_gem_name,
					 "You found a blue gemstone! It's worth 1000 points.", 1000);

const string _red_gem_name = "red gem";
const Item _red_gem(0, 0, entity_graphics[9], 103, _red_gem_name,
					"You found a red gemstone! It's worth 500 points.", 500);

const string _green_gem_name = "green gem";
const Item _green_gem(0, 0, entity_graphics[9], 101, _green_gem_name,
					  "You found a green gemstone! It's worth 200 points.", 200);